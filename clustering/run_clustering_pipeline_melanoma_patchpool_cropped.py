...
(embeddings/melanoma_patch_meanpool_cropped.npy, built by
...
OUT_DIR = os.path.join(ROOT, "clustering", "melanoma_only_patchpool_cropped")
...
if __name__ == "__main__":
    ...
    report = dict(
        subset="melanoma_only_patchpool_cropped", n_images=len(isic_ids),
        winning_config=dict(
